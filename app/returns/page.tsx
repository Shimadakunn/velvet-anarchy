        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12 space-y-8">
          ...
          <section>
            <p className="text-gray-700 leading-relaxed">
              We want you to love your Velvet Anarchy jewelry. If you're not completely
              satisfied with your purchase, we're here to help with returns and exchanges.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
              <p className="text-gray-800 font-semibold mb-2">30-Day Return Window</p>
              <p className="text-gray-700 text-sm">
                You have 30 days from the date of delivery to return items for a refund
                or exchange.
              </p>
            </div>
            ...
            <h3 className="font-semibold text-lg mb-3 mt-4">Non-Returnable Items</h3>
            <p className="text-gray-700 text-sm leading-relaxed mb-3">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">
                    Securely package your item(s) in the original packaging. Include
                    your RA number inside the package.
                  </p>
                </div>
              </div>
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed mb-3">
              We're happy to exchange items for a different size or style, subject to
            ...
            <p className="text-gray-700 text-sm leading-relaxed mt-3">
              We'll ship your exchange item once we receive and inspect your return.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <p className="text-gray-700 text-sm mb-2">
                <span className="font-semibold">Refund Amount:</span> Full purchase
            ...
            <p className="text-gray-700 text-sm leading-relaxed mt-3">
              Please allow 5-10 business days after processing for the refund to appear
              in your account, depending on your bank or card issuer.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  We provide a prepaid return label for domestic returns. The cost of
                  return shipping ($5.99) will be deducted from your refund unless the
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  recommend using a trackable shipping service, as we are not
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed mt-3">
              We'll send a replacement or issue a full refund (including shipping) at no
              cost to you.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              delivery. We'll arrange for the correct item to be sent and provide a
              prepaid label to return the incorrect item at no cost to you.
            </p>
          </section>
