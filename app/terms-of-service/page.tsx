        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12 space-y-8">
          ...
          <section>
            <p className="text-gray-700 leading-relaxed">
              Welcome to Velvet Anarchy. By accessing or using our website and services,
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              the consent of a parent or guardian. If you do not agree to these terms,
          ...
          <section>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  We make every effort to display our products accurately. However, we
                  cannot guarantee that colors and images will appear exactly as they do
                  in person. All products are subject to availability.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  reserve the right to refuse or cancel orders if pricing errors occur.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  of your order. We reserve the right to refuse or cancel any order for
                  any reason.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              other payment methods as displayed on our website. By providing payment
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              delays caused by shipping carriers or customs. For more information, please
              see our{" "}
              <a
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              software, is the property of Velvet Anarchy and is protected by copyright
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              To the fullest extent permitted by law, Velvet Anarchy shall not be liable
              for any indirect, incidental, special, consequential, or punitive damages
              resulting from your use of or inability to use our website or products.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              You agree to indemnify and hold harmless Velvet Anarchy from any claims,
          ...
          <section>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              laws of the jurisdiction in which Velvet Anarchy operates, without regard
